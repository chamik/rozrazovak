...
const About: NextPage = () => {
    ...
    return (
        <main className="flex flex-col min-h-screen purple-gradient p-4">
            <div className="m-auto w-full max-w-3xl px-10 py-7 shadow-lg items-center rounded-2xl bg-purple-50">
                ...
                <p className="mb-3"><b>Rozřazovák</b> byl vytvořen Kubíkem Hamplem (stále ještě studentem GJP-ME) v letech 2023/24 jakožto středoškolská odborná činnost a maturitní práce. Vznikl pro usnadnění celého toho procesu. Tvoje výsledky se automaticky hned vyhodnotí, testy se vytváří docela jednoduše a vše je to přes školní účet.</p>
                <p className="mb-3 font-bold">Neručím za kvalitu otázek!</p>
                <p className="mb-3">Pokud jsi měl při vyplňování nějaké potíže, dej vědět svému učiteli jazyka, případně napiš aktuálnímu správci: <a className="font-mono font-bold" href={`mailto:${MAIL}`}>{MAIL}</a></p>
